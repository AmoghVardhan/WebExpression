...
for index,row in data.iterrows():
    ...
    mpl.image.imsave(('Data/original224/'+str(index)+'.png'),image)
    imageFile = 'Data/original224/'+str(index)+'.png'
    im1 = Image.open(imageFile)
    im1 = im1.resize((224, 224), Image.BICUBIC)
    im1.save('Data/original224/'+str(index)+'.png')
    ...
    if image is not None:
        mpl.image.imsave(('Data/ImageFolder224/'+str(index)+'.png'),image)
        imageFile = 'Data/ImageFolder224/'+str(index)+'.png'
        im1 = Image.open(imageFile)
        im1 = im1.resize((224, 224), Image.BICUBIC)
        im1.save('Data/ImageFolder224/'+str(index)+'.png')
        image = cv2.imread('Data/ImageFolder224/'+str(index)+'.png',0)
...
np.save('./Data/images224.npy',images)
np.save('./Data/labels224.npy',labels)
